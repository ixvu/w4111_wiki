...
* Louise Zhou (xz2581)
＋ Scribed lecture 21: Query Processing
     ＋ Section include: What Optimization Options Do We Have? Predicate Push Down,Projection with DISTINCT clause,The Join,Nested Loops Join,Selinger Optimizer,Cost estimation, Estimate size of output, Join plan space.
     ＋ Added examples for primary and secondary Btree index, Selinger optimizer (A join B join C join D)
