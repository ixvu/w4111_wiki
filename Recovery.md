...
* Analyze the log to find status of all transactions
  * Whether a transcation has committed or not?
* Redo transactions that were committed but not in database
  * Now at the same state at the point of the crash
* Undo partial (in flight) transactions that not been committed
